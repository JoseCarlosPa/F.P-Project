...
def main():
    ...
    while opcion != 5:
        ...
        while (
                    opcion >= 4 or opcion <= 0 or opcion % 1 != 0):  # Validacion de la respuesta ingresada si no se cumple entrara hasta que sea valido
            ...
            if contador >= 3:
                ...
                print(
                "\nLos rangos para poder ingresar a una opcion son de 1 al 4,\nno pueden ser caracteres, numeros negativos, "
                "tener punto decimal o ser algun tipo de simbolo \n"
                "debera ser  1,2,3 o 4\n")
                contador = 0
